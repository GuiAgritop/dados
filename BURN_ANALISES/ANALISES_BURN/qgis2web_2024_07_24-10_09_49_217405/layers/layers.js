...
lyr_ClJddasIndustrias_27.set('fieldAliases', {'id': 'id', 'LIDERES': 'LIDERES', 'TELEFONE': 'TELEFONE', 'ENDEREÇO': 'ENDEREÇO', });
...
lyr_ClJddasIndustrias_27.set('fieldImages', {'id': 'TextEdit', 'LIDERES': '', 'TELEFONE': '', 'ENDEREÇO': '', });
...
lyr_ClJddasIndustrias_27.set('fieldLabels', {'id': 'no label', 'LIDERES': 'no label', 'TELEFONE': 'no label', 'ENDEREÇO': 'no label', });
